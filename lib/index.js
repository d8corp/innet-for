...
function For(target, parent, plugins, plugin) {
    ...
    if (typeof ofProp === 'function' || typeof sizeProp === 'function') {
            ...
            if (update) {
                ...
                var _loop_1 = function (value) {
                    ...
                    if (valueKey === oldValuesList[i]) {
                        ...
                        var watcher = watchState.unwatch(function () { return new watchState.Watch(function (update) {
                            if (update) {
                ...
                if (!i && props.else) {
                    watchState.unwatch(function () {
                        elseWatcher_1 = new watchState.Watch(function () { return innet__default['default'](props.else, mainComment_1, plugins, plugin); });
                    });
                }
            }
            else {
        ...
        if (!i) {
            if (props.else) {
                innet__default['default'](props.else, parent, plugins, innet.dom);
            }
        }
        else {
